import { Settings2, ChevronRight, Lightbulb, Target, X } from "lucide-react";
import { t } from "../i18n";
import type { RuntimeSettings } from "../lib/codex-settings";
import type { RuntimeSummary } from "./CodexSettingsPanel";

export function RuntimeSettingsShortcut({sessionId,summary,observed,running,activeTurnId,modeOverride,goal,onClearMode,onClearGoal,onOpen}:{sessionId:string;summary?:RuntimeSummary;observed?:RuntimeSettings|null;running:boolean;activeTurnId?:string|null;modeOverride?:"plan";goal?:string;onClearMode?:()=>void;onClearGoal?:()=>void;onOpen:()=>void}) {
