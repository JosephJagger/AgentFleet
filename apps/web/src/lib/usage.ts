...
export interface UsageSummary {
  ...
  accounts:{sourceMachine:string;identityKnown:boolean;observedAt:string;stale:boolean;credits?:UsageCredits|null;windows:{bucket:string;window:string;usedPercent:number;remainingPercent:number;windowMinutes:number;resetsAt:number|null}[]}[];
